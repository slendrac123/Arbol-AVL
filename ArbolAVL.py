...
class AVLTree:
    ...
    # Inserta un valor a la raiz si no esta vacio o llama a _insert()
    ...
    # Se asegura de que no este vacio, llama a _print_tree()
	def print_tree(self):
		if self.root!=None:
	...
	def _print_tree(self,cur_node):
		if cur_node!=None:
			...
			print ("El nodo {a} tiene altura {b}".format(a = str(cur_node.value), b = cur_node.height))
			self._print_tree(cur_node.right_child)
    
    # Retorna 0 si el árbol esta vacio, si no, llama a _height()
	def height(self):
		if self.root!=None:
    ...
    # Llama a _find() o retorna None si esta vació
	def find(self,value):
		if self.root!=None:
    ...
    # Llama a delete_node() con la ubicación del nodo que contiene el dato a borrar (si lo encuentra)
	...
	def delete_node(self,node):
		...
		# Retorna None y un mensaje en caso de lo encontrar el nodo respectivo
    ...
    # Retorna False si esta vació o llama a _search()
...
arbol.delete_value(10)

arbol.insert(3) # se repite, no se inserta

print(arbol.print_tree())

print("Altura: ",arbol.height())
